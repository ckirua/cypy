...
def ctx_enter(ctx: object) -> int:
    """Enter context ``ctx`` (``PyContext_Enter``). Returns 0 on success; errors raise — do not use as bool."""
    ...
def ctx_exit(ctx: object) -> int:
    """Exit context ``ctx`` (``PyContext_Exit``). Returns 0 on success; errors raise — do not use as bool."""
    ...
...
def ctxvar_reset(var: object, token: object) -> int:
    """Reset ``var`` using ``token`` (``PyContextVar_Reset``). Returns 0 on success; errors raise — do not use as bool."""
    ...
